...
use citationberg::{LayoutRenderingElement, Locale, SecondFieldAlign, Style, TextTarget};
...
pub enum ArchivedStyle {
    ...
    ElsevierWithTitles,
    /// China National Standard GB/T 7714-2025 (author-date, 中文).
    Gb77142025AuthorDate,
    /// China National Standard GB/T 7714-2025 (numeric, 中文).
    Gb77142025Numeric,
...
impl ArchivedStyle {
    ...
    pub fn by_name(name: &str) -> Option<Self> {
        match name {
            ...
            "gb-7714-2025-author-date" => Some(Self::Gb77142025AuthorDate),
            "gb-7714-2025-numeric" => Some(Self::Gb77142025Numeric),
    ...
    pub fn by_id(id: &str) -> Option<Self> {
        match id {
            ...
            "http://www.zotero.org/styles/china-national-standard-gb-t-7714-2025-author-date" => Some(Self::Gb77142025AuthorDate),
            "http://www.zotero.org/styles/china-national-standard-gb-t-7714-2025-numeric" => Some(Self::Gb77142025Numeric),
    ...
    pub fn all() -> &'static [Self] {
        &[
            ...
            Self::Gb77142025AuthorDate,
            Self::Gb77142025Numeric,
    ...
    fn bytes(self) -> &'static [u8] {
        match self {
            ...
            Self::Gb77142025AuthorDate => archived_style_bytes!("china-national-standard-gb-t-7714-2025-author-date"),
            Self::Gb77142025Numeric => archived_style_bytes!("china-national-standard-gb-t-7714-2025-numeric"),
    ...
    pub fn display_name(self) -> &'static str {
        match self {
            ...
            Self::Gb77142025AuthorDate => "China National Standard GB/T 7714-2025 (author-date, 中文)",
            Self::Gb77142025Numeric => "China National Standard GB/T 7714-2025 (numeric, 中文)",
    ...
    pub fn csl_id(self) -> &'static str {
        match self {
            ...
            Self::Gb77142025AuthorDate => "http://www.zotero.org/styles/china-national-standard-gb-t-7714-2025-author-date",
            Self::Gb77142025Numeric => "http://www.zotero.org/styles/china-national-standard-gb-t-7714-2025-numeric",
...
fn patch_style(archived: ArchivedStyle, style: &mut Style) {
    ...
    match archived {
        ArchivedStyle::AmericanMedicalAssociation => {
            if let Some(editor_macro) = style.macros.iter_mut().find(|m| m.name == "editor") {
                for child in &mut editor_macro.children {
                    if let LayoutRenderingElement::Names(names) = child {
                        if names.name().is_none() {
                            names.children.insert(0, citationberg::NamesChild::Name(citationberg::Name::default()));
                        }
                    }
                }
            }
        ...
        ArchivedStyle::SpringerVancouver => {
            ...
            // Upstream doesn't set second-field-align, unlike every other
            // NLM/Vancouver style (e.g. elsevier-vancouver), so hayagriva
            // never splits the "N. " citation-number into a first_field and
            // consumers can't tell it apart from the rest of the entry text.
            if let Some(bibliography) = style.bibliography.as_mut() {
                bibliography.second_field_align = Some(SecondFieldAlign::Flush);
            }
        }
        _ => {}
    }
