...
```json
[
  { "key": "apa", "display_name": "APA Style 7th edition", "default_locale": null, "citation_format": "author-date" },
  { "key": "ieee", "display_name": "IEEE Reference Guide version 11.29.2023", "default_locale": null, "citation_format": "numeric" },
  { "key": "gb-7714-2025-numeric", "display_name": "China National Standard GB/T 7714-2025 (numeric, 中文)", "default_locale": "zh-CN", "citation_format": "numeric" }
]
```

Sorted by `display_name`. `key` is what you pass to `hayagriva_set_style`.
`citation_format` is the style's CSL citation format (`author-date`, `author`,
`numeric`, `label`, or `note`), or null when the style has no such category.
