 ...
 * display_name:
 *   [ { "key": "apa", "display_name": "APA Style 7th edition", "default_locale": "en-US", "citation_format": "author-date" }, ... ]
 ...
 * `citation_format` is the CSL citation format (`author-date`, `author`,
 * `numeric`, `label`, or `note`), or null if the style has no such category.
